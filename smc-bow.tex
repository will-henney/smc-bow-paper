...
\citep{Vink:2001a, Vink:2021h, Bjorklund:2021k}
for the most luminous stars (\(L > \SI{e6}{L_\odot}\)).

In the Milky Way, OB stellar bow shocks can be divided into two classes:
\emph{runaways} \citep{Blaauw:1961a}
and \emph{weathervanes} \citep{Povich:2008a}.
The former have supersonic space velocities due to
ejection from a binary system or stellar cluster
\citep{Hoogerwerf:2001a, Renzo:2019b},
while the latter have low space velocities and are interacting
